...
/**
 * A <code>FoursquareConnectorLifecycleAdapter</code> is a wrapper around {@link FoursquareConnector } that adds lifecycle methods to the pojo.
 * 
 */
public class FoursquareConnectorLifecycleAdapter
    extends FoursquareConnectorCapabilitiesAdapter
    implements Disposable, Initialisable, Startable, Stoppable
{
    ...
    public void initialise() {
        Logger log = LoggerFactory.getLogger(FoursquareConnectorLifecycleAdapter.class);
